...
-The current logged-in user and their hone directory
...
-Checks whether the chosen software is installed on the syatem
...
-This script generates personalized statements, it shows user interation and open-source philosphy.
